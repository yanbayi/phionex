...
# df = pro.tdx_daily(ts_code="880633.TDX", start_date="20250722", end_date="20250722")
# print(df.to_string())
...
# df = pro.stk_factor_pro(trade_date="20250924", ts_code="000001.SZ")
...
# ============== 画图
# df = pro.stk_factor_pro(start_date="20250820",end_date="20250925", ts_code="000559.SZ",fields="""ts_code,trade_date,open,high,low,close,bbi_bfq,bbi_hfq,bbi_qfq""")
# ,fields="""ts_code,trade_date,open,high,low,close,pre_close,change,pct_change,vol,amount,vol_ratio,
#                 turn_over,swing,selling,buying,strength,activity,attack,avg_price"""
# print(df.to_string())
#
...
if __name__ == "__main__":
    ...
    df = pro.stk_factor_pro(start_date="20250901",end_date="20250925", ts_code=ts_code,
                            fields="""ts_code,trade_date,open,high,low,close,bbi_bfq""")
    df["name"] = names["name"]
